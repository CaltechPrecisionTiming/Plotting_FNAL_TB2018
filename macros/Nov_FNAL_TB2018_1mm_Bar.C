...
//ch2: photek
//ch1: sipm channel amp
//ch3: sipm channel on the other end amp
//ch1_tl: time line of sipm channel on a bar
//ch3_tl: time line of sipm channel on the other end of the bar
void Nov_FNAL_TB2018_1mm_Bar(const std::string& inFileName, const std::string& ch2  = "0", const std::string& ch1  = "16", const std::string& ch1_tl  = "16", const std::string& ch3  = "16", const std::string& ch3_tl  = "16", const std::string& time_ch1  = "LP2_10", float amp_low_ch2 = 20.0, float amp_high_ch2 = 300.0, float amp_low = 200.0, float amp_high = 850.0, float amp_low_ch3 = 20.0, float amp_high_ch3 = 300.0, float x_tile_low = 20.0, float x_tile_high = 30.0, float y_tile_low = 5.0, float y_tile_high = 12.0, float x_sipm_low = 23.0, float x_sipm_high = 27.0, float y_sipm_low = 7.0, float y_sipm_high = 10.0, const std::string& analysis_tag="")
{
	//string ch1 = "15";
	//string ch2 = "9";
	
	//string time_ch1 = "LP2_10";
	//string time_ch2 = "LP2_10";
	string time_ch2 = "gaus_mean";
	//string time_ch2 = "t_peak[0]";
	...
	//string inputDir = "/mnt/hadoop/store/group/fnal_tb_nov2018/VME/RECO/v2/";
	//string inputDir = "/mnt/hadoop/store/group/fnal_tb_nov2018/RECO/v3/";
	//string inputDir = "/mnt/hadoop/store/group/fnal_tb_nov2018/RECO/v5/";
	string inputDir = "/mnt/hadoop/store/group/fnal_tb_nov2018/RECO/v6/";
	//string plotDir = "plots_0618_timeOffset_1008/";             //local directory
	string plotDir = "FNAL_Nov2018/"; 
	//string plotDir = "/data/zhicaiz/www/sharebox/TestBeam/FNAL_Nov2018/"; //cernbox directory, recommend 

	mkdir(plotDir.c_str(), S_IRWXU | S_IRWXG | S_IRWXO);
	mkdir((plotDir+"/xybins/").c_str(), S_IRWXU | S_IRWXG | S_IRWXO);
	mkdir((plotDir+"/xybins/pdf/").c_str(), S_IRWXU | S_IRWXG | S_IRWXO);
	mkdir((plotDir+"/xybins/png/").c_str(), S_IRWXU | S_IRWXG | S_IRWXO);
	mkdir((plotDir+"/xybins/C/").c_str(), S_IRWXU | S_IRWXG | S_IRWXO);
	...
	float RMS_time_XYbins_afterTW = 0.0;
	float eRMS_time_XYbins_afterTW = 0.0;
	TH1F *h1_RMS_time_XYbins_afterTW = new TH1F("h1_RMS_time_XYbins_afterTW","h1_RMS_time_XYbins_afterTW", 400,0,400);
	
	float RMS_time_XYbins_afterTW_corrX = 0.0;
	float eRMS_time_XYbins_afterTW_corrX = 0.0;
	TH1F *h1_RMS_time_XYbins_afterTW_corrX = new TH1F("h1_RMS_time_XYbins_afterTW_corrX","h1_RMS_time_XYbins_afterTW_corrX", 400,0,400);
	
	float RMS_time_XYbins_afterTW_corrY = 0.0;
	float eRMS_time_XYbins_afterTW_corrY = 0.0;
	TH1F *h1_RMS_time_XYbins_afterTW_corrY = new TH1F("h1_RMS_time_XYbins_afterTW_corrY","h1_RMS_time_XYbins_afterTW_corrY", 400,0,400);
	...
	string cut_time = "&& abs("+time_ch1+"["+ch1_tl+"])>0.1 && abs("+time_ch1+"["+ch3_tl+"])>0.1 && abs("+time_ch2+"["+ch2+"])>0.1" ;	

	string cut_noPos = "amp["+ch1+"]>"+std::to_string(amp_low)+" && amp["+ch1+"] < "+std::to_string(amp_high)+" && amp["+ch2+"]>"+std::to_string(amp_low_ch2)+" && amp["+ch2+"]<"+std::to_string(amp_high_ch2)+" && amp["+ch3+"]>"+std::to_string(amp_low_ch3)+" && amp["+ch3+"]<"+std::to_string(amp_high_ch3)+"&& ntracks == 1 && chi2 > -0.1 && chi2 < 50.0" + cut_time;

        string cut = "amp["+ch1+"]>"+std::to_string(amp_low)+" && amp["+ch1+"] < "+std::to_string(amp_high)+" && amp["+ch2+"]>"+std::to_string(amp_low_ch2)+" && amp["+ch2+"]<"+std::to_string(amp_high_ch2)+" && amp["+ch3+"]>"+std::to_string(amp_low_ch3)+" && amp["+ch3+"]<"+std::to_string(amp_high_ch3)+" && x_dut[0] > "+std::to_string(x_tile_low)+" && x_dut[0]<"+std::to_string(x_tile_high)+" && y_dut[0]>"+std::to_string(y_tile_low)+" && y_dut[0]<"+std::to_string(y_tile_high)+"&& ntracks == 1 && chi2 > -0.1 && chi2 < 50.0" + cut_time;
        string cut_sample = "amp["+ch1+"]>"+std::to_string(amp_low)+" && amp["+ch1+"] < "+std::to_string(amp_high)+" && amp["+ch2+"]>"+std::to_string(amp_low_ch2)+" && amp["+ch2+"]<"+std::to_string(amp_high_ch2)+" && amp["+ch3+"]>"+std::to_string(amp_low_ch3)+" && amp["+ch3+"]<"+std::to_string(amp_high_ch3)+" && x_dut[0] > "+std::to_string(x_sample_low)+" && x_dut[0]<"+std::to_string(x_sample_high)+" && y_dut[0]>"+std::to_string(y_sample_low)+" && y_dut[0]<"+std::to_string(y_sample_high)+"&& ntracks == 1 && chi2 > -0.1 && chi2 < 50.0" + cut_time;
        string cut_sipm = "amp["+ch1+"]>"+std::to_string(amp_low)+" && amp["+ch1+"] < "+std::to_string(amp_high)+" && amp["+ch2+"]>"+std::to_string(amp_low_ch2)+" && amp["+ch2+"]<"+std::to_string(amp_high_ch2)+" && amp["+ch3+"]>"+std::to_string(amp_low_ch3)+" && amp["+ch3+"]<"+std::to_string(amp_high_ch3)+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)+"&& ntracks == 1 && chi2 > -0.1 && chi2 < 50.0" + cut_time;
	...
	for(int ix = 1; ix<=18; ix++)
	{
		for(int iy=1;iy<=18;iy++)
		{
			...
			tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]>>h_deltaT_x"+std::to_string(ix)+"_y"+std::to_string(iy)).c_str(),(cut_noPos+" && x_dut[0]>"+std::to_string(thisX_low)+" && x_dut[0]<"+std::to_string(thisX_high) +" && y_dut[0]>"+std::to_string(thisY_low)+" && y_dut[0]<"+std::to_string(thisY_high)).c_str());
			...
			//cout<<"h_meanAmp->GetEntries() : "<< h_meanAmp->GetEntries() <<endl;
			//cout<<"h_meanAmp Cuts "<< (cut_noPos+" && x_dut[0]>"+std::to_string(thisX_low)+" && x_dut[0]<"+std::to_string(thisX_high) +" && y_dut[0]>"+std::to_string(thisY_low)+" && y_dut[0]<"+std::to_string(thisY_high)).c_str() <<endl;
			...
			cout<<"N_usefulbins_XY_noCorr :"<< N_usefulbins_XY_noCorr <<endl;
	...
	for(int iamp = 1; iamp<=10; iamp++)
	{
		...
		tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]>>h_deltaT_amp"+std::to_string(iamp)).c_str(),(cut_sipm+" && amp["+ch1+"]>"+std::to_string(thisAmp_low)+" && amp["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());
	...
	for(int ieffamp = 1; ieffamp<=10; ieffamp++)
	{
		...
		tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]>>h_deltaT_effamp"+std::to_string(ieffamp)).c_str(),(cut_sipm+" && amp["+ch1+"]/baseline_RMS["+ch1+"]>"+std::to_string(thisAmp_low)+" && amp["+ch1+"]/baseline_RMS["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());
	...
	*/
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]>>h_deltaT").c_str(), cut.c_str());	
	h_deltaT->SetTitle("");
	h_deltaT->SetMarkerStyle( 20 );
	h_deltaT->SetMarkerColor( 1 );
	h_deltaT->SetLineColor( 1 );
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]:amp["+ch1+"]>>h2_deltaT_vs_amp").c_str(),cut.c_str());
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_p0)+" + "+std::to_string(amp_cor_p1)+"*amp["+ch1+"])>>h_deltaT_TWcorr").c_str(), cut.c_str());	
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] : x_dut[0]>>h2_deltaT_vs_x").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] : y_dut[0]>>h2_deltaT_vs_y").c_str(), (cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	...
	myC->SetGridy(1);
	myC->SetGridx(1);
	TH2F * h2_deltaT_afterTW_vs_x = new TH2F("h2_deltaT_afterTW_vs_x","h2_deltaT_afterTW_vs_x", 72, x_low, x_high, 200, maxX_t_TWcorr-0.5, maxX_t_TWcorr+0.5);
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterTW_vs_x").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	...
	h2_deltaT_afterTW_vs_x->GetYaxis()->SetRangeUser( maxX_t_TWcorr-0.5, maxX_t_TWcorr+0.5 );
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterTW_vs_y").c_str(),(cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] : x_dut[0]>>h2_deltaT_vs_x_forCorr").c_str(),cut.c_str());
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] : y_dut[0]>>h2_deltaT_vs_y_forCorr").c_str(),cut.c_str());
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterTW_vs_x_forCorr").c_str(),cut.c_str());
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterTW_vs_y_forCorr").c_str(),cut.c_str());
	...
	myC->SetGridx(0);
        ...
        tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]- (" + std::to_string(x_cor_xyonly_p0)+" + "
...
+"):amp["+ch1+"]>>h2_deltaT_vs_amp_afterXYcorr").c_str(),cut.c_str());
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_p0)+" + "+std::to_string(amp_cor_p1)+"*amp["+ch1+"] + "
...
+")>>h_deltaT_TWXYcorr").c_str(), cut.c_str());	
	...
	tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_afterXYcorr_p0)+" + "+std::to_string(amp_cor_afterXYcorr_p1)+"*amp["+ch1+"] + "
...
+") : y_dut[0]>>h2_deltaT_afterTWXY_vs_y").c_str(),(cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str()); 
	...
	for(int ix = 1; ix<=18; ix++)
	{
		for(int iy=1;iy<=18;iy++)
		{
			...
			tree->Draw(("0.5*("+time_ch1+"["+ch1_tl+"]+"+time_ch1+"["+ch3_tl+"])-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_p0)+" + "+std::to_string(amp_cor_p1)+"*amp["+ch1+"])>>h_deltaT_corr_x"+std::to_string(ix)+"_y"+std::to_string(iy)).c_str(),(cut_noPos+" && x_dut[0]>"+std::to_string(thisX_low)+" && x_dut[0]<"+std::to_string(thisX_high) +" && y_dut[0]>"+std::to_string(thisY_low)+" && y_dut[0]<"+std::to_string(thisY_high)).c_str());
			...
			//std::cout << "Bin content ("<< ix << ", " << iy << ") = " << h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy) << "\n"<< std::endl;
	...
	for(int ix = 1; ix<=18; ix++)
	{
		for(int iy=1;iy<=18;iy++)
		{
			...
			h1_RMS_time_XYbins_afterTW->Fill(h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy)-minY_t_2D_mean_afterTW + 0.01);
			//std::cout << "Bin content ("<< ix << ", " << iy << ") = " << h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy) << "\n"<< std::endl;
		}
	}

	//float min_RMS_time_XYbins_afterTW = h2_meanT_vs_xy_afterTW->GetMinimum();
	float min_RMS_time_XYbins_afterTW = 0.;
	std::cout << "min_RMS_time_XYbins_afterTW = " << min_RMS_time_XYbins_afterTW << "\n"<< std::endl;
	...
	{	
		...
		for(int iy=1;iy<=18;iy++)
		{
			if(h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy)>-1)
			{
				addX  += h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy);
				std::cout << "Bin content ("<< ix << ", " << iy << ") = " << h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy) << "\n"<< std::endl;
				std::cout << "addX = " << addX << "\n"<< std::endl;
			}
		}
		std::cout << "min_RMS_time_XYbins_afterTW = " << min_RMS_time_XYbins_afterTW << "\n"<< std::endl;
		std::cout << "addX = " << addX << "\n"<< std::endl;
		corrX = min_RMS_time_XYbins_afterTW - addX/18.;
		std::cout << "corrX = min_RMS_time_XYbins_afterTW - addX/18 = " << corrX << "\n"<< std::endl;
		for(int iy=1;iy<=18;iy++)
		{
			h1_RMS_time_XYbins_afterTW_corrX->Fill(h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy)+ corrX + 0.01);
		}
	}
	...
	for(int iy = 1; iy<=18; iy++)
	{
		...
		for(int ix=1;ix<=18;ix++)
		{
			if(h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy)>-1)
			{
				addY  += h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy);
				std::cout << "Bin content ("<< ix << ", " << iy << ") = " << h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy) << "\n"<< std::endl;
				std::cout << "addY = " << addY << "\n"<< std::endl;
			}
		}
		std::cout << "min_RMS_time_XYbins_afterTW = " << min_RMS_time_XYbins_afterTW << "\n"<< std::endl;
		std::cout << "addY = " << addY << "\n"<< std::endl;
		corrY = min_RMS_time_XYbins_afterTW - addY/18.;
		std::cout << "corrY = min_RMS_time_XYbins_afterTW - addY/18 = " << corrY << "\n"<< std::endl;
		for(int ix=1;ix<=18;ix++)
		{
			h1_RMS_time_XYbins_afterTW_corrY->Fill(h2_meanT_vs_xy_afterTW->GetBinContent(ix,iy)+ corrY + 0.01);
		}
	}
	...
	RMS_time_XYbins_afterTW = h1_RMS_time_XYbins_afterTW->GetRMS();
	eRMS_time_XYbins_afterTW = h1_RMS_time_XYbins_afterTW->GetRMSError();

	RMS_time_XYbins_afterTW_corrX = h1_RMS_time_XYbins_afterTW_corrX->GetRMS();
	eRMS_time_XYbins_afterTW_corrX = h1_RMS_time_XYbins_afterTW_corrX->GetRMSError();

	RMS_time_XYbins_afterTW_corrY = h1_RMS_time_XYbins_afterTW_corrY->GetRMS();
	eRMS_time_XYbins_afterTW_corrY = h1_RMS_time_XYbins_afterTW_corrY->GetRMSError();

	delete h1_RMS_time_XYbins_afterTW;
	delete h1_RMS_time_XYbins_afterTW_corrX;
	delete h1_RMS_time_XYbins_afterTW_corrY;
	...
	TLatex *tlatex_RMS_time_xybins_afterTW =  new TLatex();
        tlatex_RMS_time_xybins_afterTW->SetNDC();
        tlatex_RMS_time_xybins_afterTW->SetTextAngle(0);
        tlatex_RMS_time_xybins_afterTW->SetTextColor(kBlack);
        tlatex_RMS_time_xybins_afterTW->SetTextFont(63);
        tlatex_RMS_time_xybins_afterTW->SetTextAlign(11);
        tlatex_RMS_time_xybins_afterTW->SetTextSize(30);
        tlatex_RMS_time_xybins_afterTW->DrawLatex(0.5, 0.95, ("RMS = "+std::to_string(int(ceil(RMS_time_XYbins_afterTW))) +" #pm "+std::to_string(int(ceil(eRMS_time_XYbins_afterTW))) +" ps").c_str());
        tlatex_RMS_time_xybins_afterTW->DrawLatex(0.1, 0.05, ("RMS_corrX = "+std::to_string(int(ceil(RMS_time_XYbins_afterTW_corrX))) +" #pm "+std::to_string(int(ceil(eRMS_time_XYbins_afterTW_corrX))) +" ps").c_str());
        tlatex_RMS_time_xybins_afterTW->DrawLatex(0.5, 0.05, ("RMS_corrY = "+std::to_string(int(ceil(RMS_time_XYbins_afterTW_corrY))) +" #pm "+std::to_string(int(ceil(eRMS_time_XYbins_afterTW_corrY))) +" ps").c_str());
